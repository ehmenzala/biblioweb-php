...
<html lang="es">
  <head>
    ...
    <title>Biblioweb: Página de libros</title>
  ...
  <body>
      ...
      <nav class="page-nav">
        <ul class="page-nav-links" role="list">
          <li class="page-nav-item">
            <a class="page-nav-link active" href="/biblioweb/libros/">Libros</a>
          </li>
          <li class="page-nav-item">
    ...
    <main>
      ...
      <section class="container section gender-section">
        <h1>Géneros</h1>
        <ul role="list" class="genders">
          <?php foreach ($genres as $genre): ?>
          <li class="gender-item">
            <button class="gender-btn" data-genre-id="<?= $genre->get_id() ?>">
              <div class="gender-info">
                <h3 class="gender-title"><?= $genre->get_name() ?></h3>
                <p class="gender-book-count">55</p>
              </div>
              <img
                src="/biblioweb/public/assets/img/icons/wizard-hat-icon.svg"
                alt="Gorro de mágico estampado con una luna y dos estrellas con estrellas voladoras alrededor de él."
              />
            </button>
          </li>
          <?php endforeach; ?>
      ...
      <!-- For demo only -->
      <section class="container section books-section">
        <div class="section-information">
          <div class="section-information__header">
            <h2 id="genre-section-title">Género</h2>
            <p id="genre-section-type">Los mejores libros de género que puedes encontrar.</p>
          </div>
          <a class="section-information__more-link" href="#">Más</a>
        </div>

        <!-- This will be initially empty. User must select a cataegory from above to render books -->
        <ul class="book-list media-scroller" id="book-list" role="list"></ul>
      </section>
    ...
    <script src="/biblioweb/public/js/gender-btns.js"></script>
